...
with col_img:
    ...
    st.image("images/salicornia.jpeg", caption="*Salicornia europaea*", use_container_width=True)
    ...
    <div style="display: flex; align-items: center; text-align: justify;">
        <div style="width: 100%;">
            ...
            <p style="color: #555; line-height: 1.2;">
                ...
                <strong>Prof. Jaroslav Ďurkovič et al. (2025)</strong> in their study published in 
                <i>Scientific Reports</i> (Nature).
            </p>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
selected_pop = st.selectbox(
    "Select the Plant Population to Analyze:",
    options=["Ciechocinek", "Inowrocław"],
    index=0
)
